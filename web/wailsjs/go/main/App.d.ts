...
export function AddConnectionGroup(arg1:string):Promise<db.ConnectionGroup>;

export function ApplyUpdate(arg1:string):Promise<void>;

export function AssignUngroupedToGroup(arg1:string):Promise<number>;
...
export function DeleteConnectionGroupByName(arg1:string):Promise<number>;
...
export function ImportConnections():Promise<main.ConnectionsImportResult>;

export function IsProLicensed():Promise<boolean>;

export function ListActiveSessions():Promise<Array<main.SessionInfo>>;

export function ListConnectionGroups(arg1:boolean):Promise<Array<db.ConnectionGroup>>;
...
export function RenameConnectionGroupByName(arg1:string,arg2:string):Promise<void>;
